...
export default function ProductDetail() {
  ...
  const { data: product={
    "id": "840d7408-0788-4e63-9614-d4d6d16de575",
    ...
    "categoryId": "27b27101-d639-4aa9-bafd-d530a42ec7cb",
    "images": [
    ...
    "rating": "4.5",
    "reviewCount": 2
  }, isLoading } = useQuery<Product>({
    
    queryKey: ["/products", productSlug],
   
    // queryFn: async () => {
    //   const res = await fetch(
    //     "https://raw.githubusercontent.com/AjayKumar59/eCom-demo/main/apis/turquoise-and-blue-2-colour-matching-motif-bedsheet-set.json"
    //   );
    
    //   console.log("Raw response:", res); // This shows the Response object
    
    //   if (!res.ok) throw new Error("Product not found");
    
    //   const data = await res.json(); // <-- parse JSON here
    //   console.log("Parsed JSON:", data); // This shows the actual product object
